    ...
    a.fn.camera = function (b, c) {
        function bj(c) {
            ...
            if (!a(".imgLoaded", m).length) {
                ...
                var w = b.rows, x = b.cols, A = 1, C = 0, D, F, G, H, I,
                ...
                while (T < Y) {
                    ...
                    bn.css({height: Math.floor(u / w + be + 1), left: bf, top: bg, width: Math.floor(t / x + ba + 1)});
                ...
                switch (H) {
                    ...
                    case"mosaicSpiralReverse":
                        ...
                        break;
                    case"topLeftBottomRight":
                        for (var bq = 0; bq < w; bq++) for (var bp = 0; bp < x; bp++) {
                            bm.push(bp + bq)
                        }
                        bl = bm;
                        break;
                    case"bottomRightTopLeft":
                        ...
                        break;
                    case"bottomLeftTopRight":
                        for (var bq = w; bq > 0; bq--) for (var bp = 0; bp < x; bp++) {
                            bm.push(bp + bq)
                        }
                        bl = bm;
                        break;
                    case"topRightBottomLeft":
                        for (var bq = 0; bq < w; bq++) for (var bp = x; bp > 0; bp--) {
                            bm.push(bp + bq)
                        }
                        bl = bm;
                        break
                        ...
                        if (a(".cameraeased", k).length == Y) {
                            ...
                            if (c != 0) {
                                a(".cameraSlide.cameracurrent .fadeIn", g).each(function () {
                                    ...
                                    if (j.indexOf("fadeIn") != -1) {
                                        d.animate({opacity: 0}, 0).css("visibility", "visible").delay(F / c * .1 * (k - 1)).animate({opacity: 1}, F / c * .15, b)
                                    } else {
                            ...
                            if (e != 0) {
                                a(".cameraContent.cameracurrent .moveFromLeft, .cameraContent.cameracurrent .moveFromRight, .cameraContent.cameracurrent .moveFromTop, .cameraContent.cameracurrent .moveFromBottom, .cameraContent.cameracurrent .fadeIn, .cameraContent.cameracurrent .fadeFromLeft, .cameraContent.cameracurrent .fadeFromRight, .cameraContent.cameracurrent .fadeFromTop, .cameraContent.cameracurrent .fadeFromBottom", g).each(function () {
                                    ...
                                    if (h.indexOf("moveFromLeft") != -1) {
                                        ...
                                        c.css("visibility", "visible").delay(F / e * .1 * (i - 1)).animate({left: d.left}, F / e * .15, b)
                                    } else if (h.indexOf("moveFromRight") != -1) {
                                        c.css({left: t + "px", right: "auto"});
                                        c.css("visibility", "visible").delay(F / e * .1 * (i - 1)).animate({left: d.left}, F / e * .15, b)
                                    } else if (h.indexOf("moveFromTop") != -1) {
                                        c.css({top: "-" + u + "px", bottom: "auto"});
                                        c.css("visibility", "visible").delay(F / e * .1 * (i - 1)).animate({top: d.top}, F / e * .15, b, function () {
                                            c.css({top: "auto", bottom: 0})
                                        })
                                    } else if (h.indexOf("moveFromBottom") != -1) {
                                        c.css({top: u + "px", bottom: "auto"});
                                        c.css("visibility", "visible").delay(F / e * .1 * (i - 1)).animate({top: d.top}, F / e * .15, b)
                                        ...
                                        c.animate({opacity: 0}, 0).css("visibility", "visible").delay(F / e * .1 * (i - 1)).animate({opacity: 1}, F / e * .15, b)
                                    } else {
                            ...
                            L = setInterval(function () {
                                ...
                                if (h != "pie") {
                                    ...
                                    switch (U) {
                                        case"leftToRight":
                                            a("#" + i).css({right: a(".camera_bar_cont", V).width() - a(".camera_bar_cont", V).width() * bb});
                                            break;
                                        case"rightToLeft":
                                            a("#" + i).css({left: a(".camera_bar_cont", V).width() - a(".camera_bar_cont", V).width() * bb});
                                            break;
                                        case"topToBottom":
                                            a("#" + i).css({bottom: a(".camera_bar_cont", V).height() - a(".camera_bar_cont", V).height() * bb});
                                            break;
                                        case"bottomToTop":
                                            a("#" + i).css({top: a(".camera_bar_cont", V).height() - a(".camera_bar_cont", V).height() * bb});
                                            break
                                    }
                                } else {
                                    bc = bb;
        ...
        function bh() {
            if (a(s).length && !a(r).length) {
                var b = a(s).outerWidth(), c = a("ul > li", s).outerWidth(), d = a("li.cameracurrent", s).position(),
                ...
                var j = d.left, k = d.left + a("li.cameracurrent", s).outerWidth();
        ...
        a(window).bind("resize", function () {
            ...
            a("ul", s).animate({"margin-top": 0}, 0, bh);
