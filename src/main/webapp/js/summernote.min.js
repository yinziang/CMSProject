    ...
    var b, c = "function" == typeof define && define.amd, d = function (b) {
        ...
        return {
            create: function (a, c, f, g) {
                ...
                var c = a.s.offset, e = a.e.offset, f = j.fromOffsetPath(g.head(b), a.s.path),
        ...
        this.insertOrderedList = function () {
            ...
            var c = this, d = k.create().wrapBodyInlineWithPara(), e = d.nodes(j.isPara, {includeAncestor: !0}),
                h = d.paraBookmark(e), i = g.clusterBy(e, f.peq2("parentNode"));
        ...
        this.fontSize = function (a, b) {
            ...
            var q = k.createFromNode(g.head(o)).collapse(!0), r = q.getStartPoint(),
                s = k.createFromNode(g.last(o)).collapse(), t = s.getEndPoint();
    ...
    var z = function () {
        ...
        var p = function (b) {
            ...
            d.on("dragenter", function (a) {
                ...
                b.preventDefault();
                var c = b.originalEvent.dataTransfer, d = c.getData("text/html"), e = c.getData("text/plain"),
        ...
        var b = function (a, b) {
            ...
            image: function (a, b) {
                ...
                var c = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + a.shortcut.close + '</a><div class="title">' + a.shortcut.shortcuts + "</div>" + (e.isMac ? r(a, b) : s(r(a, b))) + '<p class="text-center"><a href="//summernote.org/" target="_blank">Summernote 0.6.2</a> · <a href="//github.com/summernote/summernote" target="_blank">Project</a> · <a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a></p>';
