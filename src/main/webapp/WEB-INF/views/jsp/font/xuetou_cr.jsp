...
<div class="wrapper">
    <div class="wrap">
        ...
        <div style="margin-top: 20px;">
            <h3>
                <center><hr style="margin-top: 30px">崇仁肾畅血透中心</center>
            </h3>
            <div id="brief-txt-1" class="col-lg-12 col-md-12 col-sm-12 zixun">
                <!--<div class="col-lg-9 col-md-9 col-sm-9" style="margin-top: 20px;margin-bottom: 20px"><img-->
                <!--src="images/jianjie.png"></div>-->
            ...
            <!--<img src="images/jianjie-pic2.png">-->
            <!--</div>-->
            <!--</div>-->
        </div>
...
<script>
    ...
    function load(){
        $.ajax({
            type:'GET',
            dataType: 'json',
            url: 'http://localhost:8080/admin/parts/12/pages',
