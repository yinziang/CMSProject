...
<div class="wrapper">
    <div class="wrap">
        ...
        <div class="main col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="col-lg-5 col-md-5 col-sm-56" style="margin-top: 50px;margin-bottom: 50px">
                <p id="company_cname" style="padding-left: 40px">湖北康泰化成医疗管理有限公司</p>
                <p id="company_ename" style="padding-left: 40px">Hubei Kangtai Hua Cheng Medical Management Co.,Ltd.</p>
                <p id="company_telphone" style="padding-left: 40px">027-87366568</p>
                <p id="company_email" style="padding-left: 40px">邮箱：593970826@qq.com</p>
                <p id="company_website" style="padding-left: 40px">网址：http://www.kthcyl.com</p>
                <p id="company_location" style="padding-left: 40px">地址：武汉市武昌区汉街总部国际F座704-706室</p>
            </div>
            <div class="col-lg-7 col-md-7 col-sm-7">
                <iframe src="map.html" width="100%" height="400" frameborder="0" scrolling="no">
